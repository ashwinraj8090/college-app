                    ...
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div className="row g-3">
                            ...
                            <div className="col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                              <img src="https://sbce.ac.in/wp-content/uploads/2017/05/1-1-e1582310189554.png" class="img-fluid" alt="..."/>
                              <p align="center">[College front view]</p>
                            </div>
                            <div className="col col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                              <img src="https://sbce.ac.in/wp-content/uploads/2017/05/gate2-e1582310432977.jpg" class="img-fluid" alt="..."/>
                              <p align="center">[Main gate/Entrance]</p>
                            </div>
                        </div>
                    </div>
                </div>
